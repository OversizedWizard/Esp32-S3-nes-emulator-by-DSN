...
typedef struct apu_s
{
   ...
   int16 *buffer;      /* APU-owned stereo output buffer */
   int samples_per_frame;
   int num_samples;
   int prev_sample;    /* filter state for weighted/lowpass */
   bool stereo;
...
extern "C"
{
   ...
   extern void apu_process(int16 *buffer, int num_samples, bool stereo);
